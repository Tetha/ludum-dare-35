...
public class EmitterDisplayFacingUp extends AbstractEmitterDisplay {
    ...
    public void onBulletFired(int rowsTravelled, int columnsTravelled) {
        ...
        if (emitter.getLevel() >= 1) {
            ...
            newBullet.addAction(sequence(moveTo(targetCoords.x, targetCoords.y, travelTime(rowsTravelled)),
                    removeActor()));
        }
